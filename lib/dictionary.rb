class Dictionary
  ...
  def character_to_braille_key
    ...
    @to_braille_conversion["n"] = "00.00."#1245
    @to_braille_conversion["o"] = "0..00."#145
    @to_braille_conversion["p"] = "000.0."#1235
    @to_braille_conversion["q"] = "00000."#12345
    @to_braille_conversion["r"] = "0.000."#1345
    @to_braille_conversion["s"] = ".00.0."#235
    @to_braille_conversion["t"] = ".0000."#2345
    @to_braille_conversion["u"] = "0...00"#156
    @to_braille_conversion["v"] = "0.0.00"#1356
    @to_braille_conversion["w"] = ".000.0"#2346
    @to_braille_conversion["x"] = "00..00"#1256
    @to_braille_conversion["y"] = "00.000"#12456
    @to_braille_conversion["z"] = "0..000"#1456
